    ...
    <div className="min-h-screen bg-white font-jakarta flex flex-col">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 py-8 sm:py-16 flex-grow w-full">
        <div className="bg-[#F0992A] rounded-xl sm:rounded-3xl p-6 sm:p-12 shadow-lg w-full md:w-4/5 mx-auto">
          <h2 className="text-xl sm:text-2xl font-medium text-white mb-6 text-center">Contact Us</h2>
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-6 sm:space-y-8 w-full">
            <div className="w-full">
              <label htmlFor="email" className="block text-base sm:text-lg mb-2 text-white">
                Enter Email:
              </label>
              <input
                type="email"
                ...
                className="w-full px-3 sm:px-4 py-2 sm:py-3 rounded-lg bg-white border border-black focus:ring-2 focus:ring-[#276CBE] text-black font-medium text-sm sm:text-base"
                required
              />
            </div>

            <div className="w-full">
              <label htmlFor="description" className="block text-base sm:text-lg mb-2 text-white">
                Description:
              </label>
              <textarea
                id="description"
