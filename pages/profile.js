      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-8 py-8 sm:py-16 flex-grow w-full">
        <div className="bg-[#F0992A] rounded-xl sm:rounded-3xl p-6 sm:p-12 shadow-lg space-y-6 sm:space-y-8 md:w-4/5 mx-auto">
          <div>
            ...
            <p className="bg-white px-3 sm:px-4 py-2 sm:py-3 rounded-lg break-all border border-black text-black font-medium">
          ...
          <div>
            ...
            <p className="bg-white px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-black text-black font-bold text-xl">
              {donationCount}
            </p>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:space-x-8">
            <div className="md:w-1/2">
              ...
              <p className="text-base sm:text-lg text-white font-semibold">Level 1 - Beginner</p>
            </div>
